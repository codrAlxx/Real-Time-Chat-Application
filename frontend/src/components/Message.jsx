          ...
          <div className='message-show'>
               {
                    ...
                    <div ref={scrollRef} className='my-message'>
                         <div className='image-message'>
                              ...
                              {
                                   index === message.length -1 && m.senderId === myInfo.id ? m.status === 'seen' ?  <img className='img' src={currentfriend.image} alt='' /> : m.status === 'delivared' ? <span> <FaRegCheckCircle /> </span> : <span> <FaRegCheckCircle /> </span> : ''
                              }
                              </div>
                         </div>
