          ...
          <div className='friend'>
               ...
               <div className='friend-name-seen'>
                    <div className='friend-name'>
                         ...
                         <br />
                         {
                              msgInfo && msgInfo.message.text ? <span className={ msgInfo?.senderId !== myId && msgInfo?.status !== undefined && msgInfo.status !== 'seen'?'unseen_message ' : '' }>{msgInfo.message.text.slice(0, 10) + " "}</span> : msgInfo && msgInfo.message.image ? <span>Send A image </span> : <span>Connected You </span>
                         }
...

                    {
                         ...
                         {
                              msgInfo.status === 'seen' ?
                              <img src={fndInfo.image} alt='' /> : msgInfo.status === 'delivared' ? <div className='delivared'> <FaRegCheckCircle /> </div> : <div className='unseen'> </div>
                         }
                         </div> :
                         <div className='seen-unseen-icon'>
                         {
